...
/**
 * PodAllocationPolicySimple is an PodAllocationPolicy that chooses, as the host for a VM, the host
 ...
 */
public class PodAllocationPolicySimple extends PodAllocationPolicy {
	 ...
	 * @post $none
	 */
	public PodAllocationPolicySimple(List<? extends Host> list) {
		super(list);
