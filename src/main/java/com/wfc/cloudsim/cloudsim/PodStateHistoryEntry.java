 ...
 */
public class PodStateHistoryEntry {
	...
	/**
	 * Instantiates a new PodStateHistoryEntry
	 * 
	 * @param time the time
	 ...
	 */
	public PodStateHistoryEntry(double time, double allocatedMips, double requestedMips, boolean isInMigration) {
		setTime(time);
