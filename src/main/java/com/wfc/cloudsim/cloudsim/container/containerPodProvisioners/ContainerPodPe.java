package com.wfc.cloudsim.cloudsim.container.containerPodProvisioners;


/**
 * Created by sareh on 10/07/15.
 */
public class ContainerPodPe {
     ...
     * The pe provisioner.
     */
    private ContainerPodPeProvisioner containerPodPeProvisioner;

    /**
     * Allocates a new Pe object.
     *
     * @param id            the Pe ID
     * @param containerPodPeProvisioner the pe provisioner
     * @pre id >= 0
     * @pre peProvisioner != null
     * @post $none
     */
    public ContainerPodPe(int id, ContainerPodPeProvisioner containerPodPeProvisioner) {
        setId(id);
        setContainerVmPeProvisioner(containerPodPeProvisioner);
    ...
    public ContainerPodPeProvisioner getContainerVmPeProvisioner() {
        return containerPodPeProvisioner;
    }
    /**
     * Sets the pe provisioner.
     *
     * @param containerPodPeProvisioner the new pe provisioner
     */
    public void setContainerVmPeProvisioner(ContainerPodPeProvisioner containerPodPeProvisioner) {
        this.containerPodPeProvisioner = containerPodPeProvisioner;
    }
}
