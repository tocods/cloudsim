 ...
 */
public class PowerContainerPod extends ContainerPod {
    ...
    public double updateVmProcessing(final double currentTime, final List<Double> mipsShare) {
        Log.printLine("PowerContainerPod is updating process, mipsShare is " + mipsShare);
    ...
    public double[] getUtilizationHistoryList(){
        double[] utilizationHistoryList = new double[PowerContainerPod.HISTORY_LENGTH];
