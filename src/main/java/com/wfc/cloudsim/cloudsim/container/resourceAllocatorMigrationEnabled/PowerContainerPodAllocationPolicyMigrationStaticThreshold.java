 ...
 */
public class PowerContainerPodAllocationPolicyMigrationStaticThreshold extends PowerContainerPodAllocationPolicyMigrationAbstract {
     ...
     */
    public PowerContainerPodAllocationPolicyMigrationStaticThreshold(
