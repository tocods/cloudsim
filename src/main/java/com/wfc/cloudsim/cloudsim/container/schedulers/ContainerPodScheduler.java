package com.wfc.cloudsim.cloudsim.container.schedulers;
...
import com.wfc.cloudsim.cloudsim.container.lists.ContainerPodPeList;
 ...
 * Simulation of Clouds Licence: GPL - http://www.gnu.com.wfc.cloudsim/copyleft/gpl.html
 *
...
/**
 * PodScheduler is an abstract class that represents the policy used by a VMM to share processing
 ...
 */
public abstract class ContainerPodScheduler {
     ...
     */
    private Map<String, List<ContainerPodPe>> peMap;
     ...
     * @post $none
     */
    public ContainerPodScheduler(List<? extends ContainerPodPe> pelist) {
        setPeList(pelist);
        setPeMap(new HashMap<String, List<ContainerPodPe>>());
     ...
     * @post $none
     */
    public abstract boolean allocatePesForVm(ContainerPod vm, List<Double> mipsShare);
     ...
     * @post $none
     */
    public abstract void deallocatePesForVm(ContainerPod vm);
     ...
     */
    public List<ContainerPodPe> getPesAllocatedForContainerVM(ContainerPod vm) {
     ...
     * @post $none
     */
    public List<Double> getAllocatedMipsForContainerVm(ContainerPod vm) {
     ...
     */
    public double getTotalAllocatedMipsForContainerVm(ContainerPod vm) {
        double allocated = 0;
     ...
     */
    protected <T extends ContainerPodPe> void setPeList(List<T> peList) {
        this.peList = peList;
    }
     ...
     * @return the pe map
     */
    public Map<String, List<ContainerPodPe>> getPeMap() {
        return peMap;
    }
     ...
     */
    protected void setPeMap(Map<String, List<ContainerPodPe>> peMap) {
        this.peMap = peMap;
    }
