...
import com.wfc.cloudsim.cloudsim.core.predicates.PredicateAny;
import com.wfc.cloudsim.cloudsim.core.predicates.PredicateNone;
	...
	public static boolean runClockTick() {
		...
		for (int i = 0; i < entities_size ; i++) {
			...
			if (ent.getState() == SimEntity.RUNNABLE) {
				//Log.printLine("start simEntity: " + ent.getName());
				ent.run();
			}
		}
