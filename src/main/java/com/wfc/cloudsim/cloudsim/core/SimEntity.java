...
package com.wfc.cloudsim.cloudsim.core;

import com.wfc.cloudsim.cloudsim.Log;
import com.wfc.cloudsim.cloudsim.NetworkTopology;
import com.wfc.cloudsim.cloudsim.core.predicates.Predicate;
...
public abstract class SimEntity implements Cloneable {
	...
	public abstract void shutdownEntity();
         ...
         * in the {@link #processEvent(com.wfc.cloudsim.cloudsim.core.SimEvent)} method.
         * 
         * @see #processEvent(com.wfc.cloudsim.cloudsim.core.SimEvent) 
         */
	public void run() {
		...
		while (ev != null) { 
			...
			Log.printLine(getName() + " is now running");
                       processEvent(ev);
