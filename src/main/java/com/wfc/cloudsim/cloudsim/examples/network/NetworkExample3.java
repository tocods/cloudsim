...
package com.wfc.cloudsim.cloudsim.examples.network;

import com.wfc.cloudsim.cloudsim.*;
import com.wfc.cloudsim.cloudsim.Pod;
import com.wfc.cloudsim.cloudsim.core.CloudSim;
import com.wfc.cloudsim.cloudsim.provisioners.BwProvisionerSimple;
import com.wfc.cloudsim.cloudsim.provisioners.PeProvisionerSimple;
import com.wfc.cloudsim.cloudsim.provisioners.RamProvisionerSimple;
...
public class NetworkExample3 {
	...
	/** The vmlist. */
	private static List<Pod> vmlist1;
	private static List<Pod> vmlist2;
	...
	public static void main(String[] args) {
		...
		try {
			...
			vmlist1 = new ArrayList<Pod>();
			vmlist2 = new ArrayList<Pod>();
			...
			Pod pod1 = new Pod(vmid, brokerId1, mips, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());

			//the second VM: this one belongs to user2
			Pod pod2 = new Pod(vmid, brokerId2, mips, pesNumber, ram, bw, size, vmm, new CloudletSchedulerTimeShared());
	...
	private static Datacenter createDatacenter(String name){
		...
		hostList.add(
				new Host(
					...
					storage,
					peList,
					new PodSchedulerSpaceShared(peList)
				)
			); // This is our machine
