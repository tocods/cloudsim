 ...
 */
public class PowerPodAllocationPolicyMigrationMedianAbsoluteDeviation extends
		PowerPodAllocationPolicyMigrationAbstract {
	...
	/** The fallback VM allocation policy to be used when
         ...
         * data to be computed. */
	private PowerPodAllocationPolicyMigrationAbstract fallbackVmAllocationPolicy;

	/**
	 * Instantiates a new PowerPodAllocationPolicyMigrationMedianAbsoluteDeviation.
	 * 
	 ...
	 */
	public PowerPodAllocationPolicyMigrationMedianAbsoluteDeviation(
	 ...
	 */
	public PowerPodAllocationPolicyMigrationAbstract getFallbackVmAllocationPolicy() {
