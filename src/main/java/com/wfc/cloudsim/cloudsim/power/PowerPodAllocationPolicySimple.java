 ...
 */
public class PowerPodAllocationPolicySimple extends PowerPodAllocationPolicyAbstract {

	/**
	 * Instantiates a new PowerPodAllocationPolicySimple.
	 * 
	 * @param list the list
	 */
	public PowerPodAllocationPolicySimple(List<? extends Host> list) {
		super(list);
	}
