 ...
 */
public class PowerPodSelectionPolicyMaximumCorrelation extends PowerPodSelectionPolicy {

	/** The fallback VM selection policy to be used when
         * the  Maximum Correlation policy doesn't have data to be computed. */
	private PowerPodSelectionPolicy fallbackPolicy;

	/**
	 * Instantiates a new PowerPodSelectionPolicyMaximumCorrelation.
	 * 
	 * @param fallbackPolicy the fallback policy
	 */
	public PowerPodSelectionPolicyMaximumCorrelation(final PowerPodSelectionPolicy fallbackPolicy) {
		super();
		setFallbackPolicy(fallbackPolicy);
	}

	@Override
	public Pod getVmToMigrate(final PowerHost host) {
	 ...
	 */
	protected double[][] getUtilizationMatrix(final List<PowerPod> vmList) {
		int n = vmList.size();
	 ...
	 */
	protected int getMinUtilizationHistorySize(final List<PowerPod> vmList) {
		int minSize = Integer.MAX_VALUE;
		for (PowerPod vm : vmList) {
	 ...
	 */
	public PowerPodSelectionPolicy getFallbackPolicy() {
	 ...
	 */
	public void setFallbackPolicy(final PowerPodSelectionPolicy fallbackPolicy) {
