...
package com.wfc.cloudsim.cloudsim.power.lists;
...
/**
 * PowerPodList is a collection of operations on lists of power-enabled VMs.
 * 
 ...
 * @todo It is a list, so it would be better inside the com.wfc.cloudsim.cloudsim.lists package.
 * This class in fact doesn't use a list or PowerPod, but a list of Pod.
 * The used methods are just of the Pod class, thus doesn't have
 ...
 * So, the method of this class would be moved to the PodList class
 * and the class erased.
 */
public class PowerPodList extends PodList {
	 ...
	 */
	public static <T extends Pod> void sortByCpuUtilization(List<T> vmList) {
