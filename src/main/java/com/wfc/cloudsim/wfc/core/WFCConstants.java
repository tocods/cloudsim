...
import com.wfc.cloudsim.cloudsim.power.models.PowerModelSpecPowerHpProLiantMl110G4Xeon3040;
import com.wfc.cloudsim.cloudsim.power.models.PowerModelSpecPowerHpProLiantMl110G5Xeon3075;
import com.wfc.cloudsim.cloudsim.power.models.PowerModelSpecPowerIbmX3550XeonX5670;
import com.wfc.cloudsim.cloudsim.power.models.PowerModelSpecPowerIbmX3550XeonX5675;
...
//-----------------------Simulation
    ...
    public static  boolean CAN_PRINT_SEQ_LOG = true;
...
//-----------------------Number
    ...
    public static   int WFC_NUMBER_HOSTS = 40;
    public static   int WFC_NUMBER_VMS = 101;
    ...
    public static   int WFC_JOB_NUMBER = 101;
    public static  int  WFC_NUMBER_VM_PES = 2; //number of cpus
    public static  int WFC_NUMBER_HOST_PES = 8+2; //number of cpus
//-----------------------Cloudlet
...
//-----------------------Container    
    ...
    public static   int   WFC_CONTAINER_MIPS = 1000;
    ...
    public static Map<Integer, Double> hostMips = new HashMap<>();
    public static Map<Integer, Double> podMips = new HashMap<>();
    public static Map<Integer, Double> containerMips = new HashMap<>();
    
//----------------------- VM    
    
    public static  long WFC_VM_SIZE = 10000; //image size (MB)
    public static  int  WFC_VM_RAM = 1024; //vm memory (MB)
    public static  int  WFC_VM_MIPS = 1000;
    public static  long WFC_VM_BW = 100;
...
//----------------------- HOST    
    ...
    public static  long WFC_HOST_BW = 1000;
