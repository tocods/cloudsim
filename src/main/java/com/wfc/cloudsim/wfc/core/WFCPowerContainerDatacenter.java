...
import com.wfc.cloudsim.cloudsim.container.utils.CostumeCSVWriter;
...
import com.wfc.cloudsim.cloudsim.core.predicates.PredicateType;
...
//by arman I commented                Log.printConcatLine(CloudSim.clock(),": The total number of Migrations is:  ",getVmMigrationCount());
    ...
    /*
     * (non-Javadoc)
     * @see com.wfc.cloudsim.cloudsim.Datacenter#processVmMigrate(com.wfc.cloudsim.cloudsim.core.SimEvent,
     * boolean)
     */
    @Override
