...
import com.wfc.cloudsim.workflowsim.clustering.BasicClustering;
import com.wfc.cloudsim.workflowsim.clustering.BlockClustering;
import com.wfc.cloudsim.workflowsim.clustering.HorizontalClustering;
import com.wfc.cloudsim.workflowsim.clustering.VerticalClustering;
import com.wfc.cloudsim.workflowsim.clustering.balancing.BalancedClustering;
import com.wfc.cloudsim.workflowsim.utils.ClusteringParameters;
...
public final class WFCEngineClustering extends SimEntity {
     ...
     * @post $none
     */
    public WFCEngineClustering(String name, int schedulers, List<ContainerPod> pods, List<Container> containers) throws Exception {
        super(name);
        ...
        this.workflowEngine = new WFCEngine(name + "_Engine_0", schedulers, pods, containers);
        this.workflowEngineId = this.workflowEngine.getId();
    }

    List<Integer> getSchedulerIds() {
        return this.workflowEngine.getSchedulerIds();
    }
